...
func get_description() -> String:
	var all_descriptions: Dictionary = {
		"Clank": "INCOMPLETE ANCESTY",
		"Drakona": "INCOMPLETE ANCESTY",
		...
		"Elf": "INCOMPLETE ANCESTY",
		"Faerie": "INCOMPLETE ANCESTY",
		...
		"Galapa": "INCOMPLETE ANCESTY",
		"Giant": "INCOMPLETE ANCESTY",
		"Goblin": "INCOMPLETE ANCESTY",
		"Halfling": "Halflings are small humanoids with large hairy feet and prominent rounded ears. Members of this ancestry live for around 150 years, and a halfling’s appearance is likely to remain youthful even as they progress from adulthood into old age.",
		"Human": "INCOMPLETE ANCESTY",
