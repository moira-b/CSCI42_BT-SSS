...
func test_signals():
	...
	assert_connected(char_display.delete_button.pressed, char_display._on_delete_button_pressed)
	assert_connected(char_display.class_header_button.pressed, char_display._on_header_panel_clicked)
	assert_connected(char_display.multiclass_header_button.pressed, char_display._on_header_panel_clicked)
	assert_connected(char_display.ancestry_header_button.pressed, char_display._on_header_panel_clicked)
	assert_connected(char_display.community_header_button.pressed, char_display._on_header_panel_clicked)
